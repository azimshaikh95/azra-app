...
GSHEET_URL = "https://docs.google.com/spreadsheets/d/{SPREADSHEET_ID}"+st.secrets["SPREADSHEET_ID"]
...
st.set_page_config(page_title="Azim Bug report", page_icon="🐞", layout="centered")
